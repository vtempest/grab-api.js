...
[Hey API](https://heyapi.dev) turns an OpenAPI spec into a fully typed SDK — one function and one set of types per endpoint. It ships clients built on fetch, axios, ky and others; [`heyapi-client-grab`](https://github.com/vtempest/GRAB-URL/tree/master/packages/heyapi-client-grab) adds one built on grab.
...
New to this? [Set Up Hey API with GRAB](/docs/openapi-services/heyapi-setup) walks the same thing through step by step, with framework wiring and troubleshooting. This page is the reference.
