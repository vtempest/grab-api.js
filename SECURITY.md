...
1. GitHub Private Vulnerability Reporting:
   https://github.com/OpenSourceAGI/GRAB-URL/security/advisories/new
...
- Unauthorized access to fetched content, user data, cached documents, or provider credentials
...
- Extraction-provider, LLM-provider, and database credentials
