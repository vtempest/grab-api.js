/**
 * @file spinner.tsx
 * @description shadcn/ui-style loading spinner with eight variants. Every variant
 * draws with `currentColor`, so a text color utility (`text-primary`, `text-fd-muted-foreground`, …)
 * is all that is needed to restyle it. The same eight animations are available as
 * standalone SVG strings from `loading-animations/svg` for non-React consumers.
 */
...
/** Every variant name, in the order they are showcased in the docs. */
